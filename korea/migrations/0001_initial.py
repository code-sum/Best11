# Generated by Django 3.2.13 on 2022-12-01 13:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.CharField(choices=[('FW (공격수)', 'FW (공격수)'), ('MF (미드필더)', 'MF (미드필더)'), ('DF (수비수)', 'DF (수비수)'), ('GK (골키퍼)', 'GK (골키퍼)')], max_length=10)),
