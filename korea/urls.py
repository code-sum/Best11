...
urlpatterns = [
    ...
    path(
        "detail/<int:player_pk>/comments/", views.comment_create, name="comment_create"
    ),  # 뇌피셜 작성
    path(
        "detail/<int:player_pk>/<int:comment_pk>/update/",
        views.comment_update,
        name="comment_update",
    ),  # 뇌피셜 수정
    path(
        "detail/<int:player_pk>/<int:comment_pk>/delete/",
        views.comment_delete,
        name="comment_delete",
    ),  # 뇌피셜 삭제
    path(
        "detail/<int:player_pk>/<int:comment_pk>/likes/", views.likes, name="likes"
    ),  # 뇌피셜 좋아요
    ...
    path(
        "detail/<int:player_pk>/<int:comment_pk>/block/", views.block, name="block"
    ),  # 피셜 신고하기
]
